...
local games = {
    ...
    [7569392700] = {
        ...
        ScriptURL = "https://raw.githubusercontent.com/jaydensrc/Syntex/refs/heads/main/SquidGameRoleplay.lua?token=GHSAT0AAAAAADRGQ277KZUGB6HIHWZ5ONHG2J5HTHA",
        Icon = "gamepad"
    }
}
...
local WebhookResponse = HttpRequest({
    ...
    Body = HttpService:JSONEncode({
        [game.Players.LocalPlayer.UserId] = {
            ["LicenseInformation"] = {
                ["LicenseKey"] = readfile("Syntex/"..gethwid()..".key"),
                ["HardwareID"] = gethwid(),
            },
            ["ExecutorInformation"] = {
